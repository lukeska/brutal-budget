...
<template>
    <div>
        <div class="border-b border-gray-200 bg-white p-6 lg:p-8">
            ...
            <h1 class="mt-8 text-2xl font-medium text-gray-900">Welcome to your Jetstream application!</h1>
            ...
            <p class="mt-6 leading-relaxed text-gray-500">
                ...
                and enjoyable. We believe you should love expressing your creativity through programming, so we have
        ...
        <div class="grid grid-cols-1 gap-6 bg-gray-200 bg-opacity-25 p-6 md:grid-cols-2 lg:gap-8 lg:p-8">
            ...
            <div>
                <div class="flex items-center">
                    ...
                    <h2 class="ms-3 text-xl font-semibold text-gray-900">Authentication</h2>
                </div>
